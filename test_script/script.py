...
def default_evaluation_params():
    ...
    return {
                ...
                'TRANSCRIPTIONS':False,#Detections must include transcription value
...
def validate_data(gtFilePath, submFilePath,evaluationParams):
    ...
    for k in subm:
        ...
        rrc_evaluation_funcs.validate_lines_in_file(k,subm[k],evaluationParams['CRLF'],evaluationParams['LTRB'],evaluationParams['TRANSCRIPTIONS'],evaluationParams['CONFIDENCES'])
...
def evaluate_method(gtFilePath, submFilePath, evaluationParams):
    ...
    for resFile in gt:
        ...
        if resFile in subm:
            ...
            pointsList,confidencesList,_ = rrc_evaluation_funcs.get_tl_line_values_from_file_contents(detFile,evaluationParams['CRLF'],evaluationParams['LTRB'],evaluationParams['TRANSCRIPTIONS'],evaluationParams['CONFIDENCES'])
            for n in range(len(pointsList)):
                points = pointsList[n]
                if evaluationParams['LTRB']:
