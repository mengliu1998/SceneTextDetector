...
def get_tl_line_values(line,LTRB=True,withTranscription=False,withConfidence=False,imWidth=0,imHeight=0):
    ...
    if LTRB:
        ...
        if(validate_clockwise_points(points)):
            points = [points[0],points[1],points[6],points[7],points[4],points[5],points[2],points[3]] 
...
def get_tl_line_values_from_file_contents(content,CRLF=True,LTRB=True,withTranscription=True,withConfidence=False,imWidth=0,imHeight=0,sort_by_confidences=True):
    """
