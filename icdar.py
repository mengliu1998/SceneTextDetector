...
tf.app.flags.DEFINE_string('training_data_path', '../../Dataset/MLT2019/MLT_train+validation/',
    ...
    while True:
        ...
        for i in index:
            try:
                ...
                score_maps.append(score_map[::2, ::2, np.newaxis].astype(np.float32))
                geo_maps.append(geo_map[::2, ::2, :].astype(np.float32))
